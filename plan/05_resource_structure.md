...
각 자원은 자산 매수, 유동성 확보, 예약, 분기 운영에 사용된다.
...
유동성 확보로 선택할 수 있는 기본 자원은 다음 4개이다.
...
딜 칩은 예약을 통해 얻는 특수 자원이다.

딜 칩은 전문 자원 비용 슬롯을 대체할 수 있으며, 추가로 현금 비용을 낮춘다.
...
조달 현금은 플레이어가 유동성 확보를 통해 확보한 현금이다.
...
딜 칩은 예외적으로 모든 전문 자원 비용 슬롯에 배치할 수 있다.
...
현재 선택 상태에서 더 이상 유효 선택지가 없으면 유동성 확보를 자동 종료한다.
...
딜 칩은 자산 매수 시 전문 자원 비용 슬롯을 대체할 수 있다.
...
딜 칩 1개는 추가로 기본 현금 비용을 1 낮춘다.

```text
투여한 딜 칩 수만큼 기본 현금 비용 감소
```
...
- 자산 인컴과 분기 마감 정산 수익은 운용 수익에 포함한다.
