...
보유 자산의 영업일 시작 현금은 모든 영업일 시작에 발생한다.
...
다음 영업일로 넘어간 경우
→ 다음 영업일 시작 시 운용 수익 발생
```

단, 다음 영업일이 존재하지 않는 경우에는 운용 수익이 발생하지 않는다.
...
- 마지막 영업일 종료 후에는 다음 영업일 운용 수익이 발생하지 않고 분기 마감으로 간다.
- 예약 카드는 분기와 회계년도 전환 후에도 유지한다.
- 시장 테이프는 분기/회계년도 전환에 따라 바뀌지만, 예약 구역은 유지된다.
```
