...
첫 번째 매수가 예약 카드라면 해당 예약 구역만 비운다.
...
중앙 은행은 비활성화하거나 클릭 시 짧은 피드백만 준다.
