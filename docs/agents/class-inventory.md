...
6. Buttons call `BusinessDayFlow`, `MarketTape.Advance`, or `MarketTape.Refresh`, then all UI is refreshed from the new state.
...
| `RunPerformanceState` | `Runtime/RunModels.cs` | Current 운용 수익 and 조달 현금 totals. |
