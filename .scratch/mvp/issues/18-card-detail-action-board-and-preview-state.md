...
Do not implement this issue as written. The stock rules overhaul removes the card detail action board, preview-state behavior, and Market Peek flow. Card inspection now happens through hover enlargement inside the single market state.
