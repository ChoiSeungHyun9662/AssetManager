...
Do not implement this issue as written. The stock rules overhaul removes the separate reservation zone. Portfolio board work should follow the new 8-slot stock portfolio, market-slot reservation, value/dividend/revenue terminology, and integration QA issues.
