...
매수한 자산을 보유 자산으로 표시하고, 다음 영업일 시작부터 현금을 제공하게 하며, 그 현금을 운용 수익으로 기록한다. 예약 카드와 시장 카드는 운용가치, 운용 수익, 분기 마감 정산 대상에서 제외되는 상태 분리가 명확해야 한다.

## Code work

- AssetCard module에 OwnedAssetState와 AcquiredOrder를 연결한다.
- 보유 자산 목록을 관리하고 보유 자산 수와 총 운용가치를 계산한다.
- 보유 자산의 영업일 시작 현금 적용 함수를 구현한다.
- 운용 수익은 다음 영업일 시작 시 발생하고 매수한 당일 즉시 발생하지 않는다.
- 운용 성과 현금은 ResourceLedger의 운용 수익 경로로 기록한다.
- 예약 카드와 시장 카드는 보유 자산 계산, 운용가치 계산, 운용 수익 계산에서 제외한다.
...
- 다음 영업일 시작 시 보유 자산의 현금 제공 결과가 현금과 운용 수익 표시에서 갱신되게 연결한다.

## Verification

- 시장 카드를 매수하면 보유 자산 수가 증가한다.
- 매수 직후 같은 영업일에는 해당 카드 운용 수익이 발생하지 않는다.
- 다음 영업일 시작 시 해당 카드의 영업일 시작 현금이 현금과 분기 운용 수익에 반영된다.
- 보유 자산 운용가치 합계가 표시된다.
- 예약 카드와 시장 카드는 운용가치와 운용 수익에 포함되지 않는다.
