...
- 분기 운용 수익은 보유 자산의 영업일 시작 현금과 분기 마감 정산 수익을 포함하고 조달 현금은 제외한다.
...
- 자원 확보로 얻은 현금만 있는 경우 분기 운용 수익에 포함되지 않는다.
- 보유 자산의 영업일 시작 현금과 분기 마감 정산 수익은 분기 운용 수익에 포함된다.
- 분기 목표 미달 달성률별로 환매 압력 증가량이 올바르게 계산된다.
- 환매 압력이 10 이상이 되면 실패 화면으로 이동하고 다음 일정으로 진행하지 않는다.

## Acceptance criteria

- [x] 분기 마감은 마지막 영업일 종료 후 발생한다.
- [x] 마지막 영업일 종료 후 다음 영업일 운용 수익은 발생하지 않는다.
- [x] 정산 수익은 목표 달성률 계산 전에 운용 수익으로 반영된다.
- [x] 조달 현금은 분기 운용 수익에 포함하지 않는다.
- [x] 목표 달성률별 환매 압력 증가량이 적용된다.
- [x] 환매 압력 증가 후 즉시 한도 검사를 한다.
- [x] 환매 압력 10 이상이면 RunState.Failed가 되고 실패 화면으로 이동한다.
- [x] 실패 시 다음 영업일, 다음 분기, 휴가, 최종 정산으로 가지 않는다.
